...
parser.add_argument("-hapA", "--hapA", dest="hapA", action= "store", help="Haplotype A from reference genome (fasta). Warning: the name of each chromosome should be chr* in both haplotypes")
parser.add_argument("-hapB", "--hapB", dest="hapB", action= "store", help="Haplotype B from reference genome (fasta). Warning: the name of each chromosome should be chr* in both haplotypes")
